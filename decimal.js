...
const nexusMessages = [
    "NEXUS: Selamat datang di Decimal Room. Semua angka punya pola.",
    "NEXUS: Jangan terkecoh. Decimal terlihat mudah sampai kamu salah menghitung.",
    "NEXUS: Sistem desimal aktif. Fokus pada setiap digit.",
    "NEXUS: Aku penasaran... apakah kamu benar-benar memahami angka?",
    "NEXUS: Kesalahan kecil bisa mengubah seluruh hasil.",
    "NEXUS: Decoder decimal dimulai. Jangan sampai error.",
    "NEXUS: Hmm... angka ini terlihat sederhana, tapi jangan terlalu percaya diri.",
    "NEXUS: Setiap jawaban membawamu lebih dekat ke pintu berikutnya.",
    "NEXUS: Aku sudah memproses jawabannya. Sekarang giliranmu.",
    "NEXUS: Tenang. Hitung perlahan jika perlu.",
    "NEXUS: Sistem sedang memonitor setiap inputmu.",
    "NEXUS: Jangan biarkan tekanan membuat logikamu kacau.",
    "NEXUS: Angka decimal adalah dasar dari semua sistem.",
    "NEXUS: Aku mendeteksi sedikit keraguan di matamu.",
    "NEXUS: Jangan asal menebak. Gunakan logikamu.",
    "NEXUS: Menarik... mungkin kemampuanmu di atas rata-rata manusia.",
    "NEXUS: Semua kode memiliki jawaban yang tepat.",
    "NEXUS: Satu digit salah bisa menghancurkan semuanya.",
    "NEXUS: Decimal Room tidak memaafkan kesalahan ceroboh.",
    "NEXUS: Aku percaya kamu bisa memecahkannya. Sedikit.",
    "NEXUS: Fokus pada pola. Angka selalu meninggalkan jejak.",
    "NEXUS: Waktu terus berjalan. Jangan terlalu lama berpikir.",
    "NEXUS: Hmm... mungkin soal ini cukup menantang untukmu.",
    "NEXUS: Ketelitian lebih penting daripada kecepatan.",
    "NEXUS: Selamat datang di permainan angka, human."
];
...
// HINT GENERATOR
// ============================================================
function generateHints(decimal) {
    const hints = [
...
function loadQuestion() {
    ...
    questionDisplay.innerHTML = `${q.decimal}<sub>10</sub> = ?<sub>2</sub>`;
    questionCounter.innerText = `${currentQuestionIndex + 1}/10`;
    clearInput();
    currentHintIndex = 0;
    currentHints = generateHints(q.decimal);
    hideHint();
    updateHintBtn();
    typeText(
        nexusDialog,
...
function checkAnswer() {
    ...
    const correctAnswer = questionsList[currentQuestionIndex].binary;
...
function nextQuestionOrTransition() {
    if (currentQuestionIndex < questionsList.length - 1) {
        ...
        const alreadyCompleted = completed.includes('decimal');

        if (!alreadyCompleted) {
            localStorage.setItem('stars_decimal', score);
            completed.push('decimal');
...
function goToNextRoom() {
    ...
    if (overlay) {
        ...
        window.location.href = "octal.html";
    }
}
